  ...
  return (
    ...
    >
      ...
      <div className="fixed top-6 left-6 z-50">
        <button
          onClick={() => navigate(-1)}
          className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 backdrop-blur-xl border border-slate-200 text-sm font-bold uppercase tracking-widest hover:bg-fuchsia-600 hover:text-white hover:border-fuchsia-600 transition-all"
        >
      ...
      <div className="container mx-auto px-6 md:px-16 py-12 md:py-16">
            ...
            <div className="sticky top-24 space-y-8">
              ...
              <div className="border-t border-slate-200 pt-8 space-y-4">
                ...
                >
                  ...
                  <div className="w-10 h-10 rounded-full border-2 border-slate-900 flex items-center justify-center group-hover:bg-fuchsia-600 group-hover:border-fuchsia-600 group-hover:text-white transition-all">
                    <ArrowUpRight className="w-5 h-5" />
                  </div>
                </Link>
              </div>
          ...
          <div className="mt-16 md:mt-24">
            <div className="flex items-center justify-between mb-6">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-slate-500 hover:text-fuchsia-600 transition-colors"
              >
        ...
        <div className="border-t border-slate-200 mt-16 pt-12 grid grid-cols-2 gap-6">
          ...
          >
            <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-slate-400">Vorig project</span>
          ...
          >
            <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-slate-400">Volgend project</span>
