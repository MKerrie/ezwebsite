        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <div className="relative group">
              ...
              <div className="absolute -bottom-4 right-4 md:-bottom-8 md:-right-8 bg-fuchsia-600 text-white p-4 md:p-8 rounded-2xl md:rounded-full flex items-center justify-center z-20 shadow-xl shadow-fuchsia-900/20">
