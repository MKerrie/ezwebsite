        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
          ...
          <div className="lg:w-5/12">
            ...
            <div className="space-y-8 md:space-y-10">
              ...
              <a href="https://wa.me/31626404047" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-6 group cursor-pointer w-fit max-w-full">
                <motion.div
                  whileHover={{ rotate: 15, scale: 1.1 }}
                  className="flex-shrink-0 w-12 h-12 md:w-14 md:h-14 rounded-full bg-white border border-slate-200 flex items-center justify-center text-slate-900 group-hover:bg-violet-600 group-hover:text-white group-hover:border-violet-600 transition-all duration-300 shadow-md"
                >
                ...
                <div className="overflow-hidden">
                  ...
                  <p className="font-display font-bold text-lg md:text-2xl group-hover:text-violet-500 transition-colors truncate">06 26 40 40 47</p>
                </div>
              </a>
