...
const StyledInput = ({ label, type = "text", placeholder, value, onChange, required = false }: any) => (
    <div className="flex flex-col gap-2 group w-full">
        <label className="text-xs font-bold uppercase tracking-widest text-slate-500 dark:text-gray-400 ml-1 group-focus-within:text-blue-600 dark:group-focus-within:text-blue-400 transition-colors">
...
const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" ref={ref} className="py-24 bg-slate-50 dark:bg-black text-slate-900 dark:text-white relative overflow-hidden transition-colors duration-300 w-full">
      ...
      <div className="absolute top-1/2 right-0 w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-blue-900/5 dark:bg-blue-900/10 blur-[80px] md:blur-[150px] pointer-events-none rounded-full transform -translate-y-1/2 translate-x-1/2" />
            ...
            <div className="space-y-8 md:space-y-10">
              ...
              <a href="tel:+31612345678" className="flex items-center space-x-6 group cursor-pointer w-fit max-w-full">
                ...
                <div className="overflow-hidden">
                  ...
                  <p className="font-display font-bold text-lg md:text-2xl group-hover:text-blue-500 transition-colors truncate">+31 6 1234 5678</p>
                </div>
              </a>
            </div>
          </div>
            ...
            <div className="bg-slate-100 dark:bg-neutral-900/50 backdrop-blur-xl border border-slate-200 dark:border-white/10 p-6 md:p-12 rounded-[2rem] md:rounded-[2.5rem] shadow-xl dark:shadow-2xl relative overflow-hidden group">
              ...
              <div className="flex justify-between items-center mb-8 md:mb-10">
                 ...
                 <div className="flex items-center gap-2">
                     <div className={`w-2 h-2 rounded-full ${formState === 'success' ? 'bg-blue-500' : 'bg-green-500'} shadow-[0_0_10px_currentColor] animate-pulse`}></div>
                  ...
                  {formState === 'success' ? (
                      ...
                      >
                          ...
                          <button 
                            ...
                            className="text-sm font-bold uppercase tracking-widest text-blue-500 hover:text-blue-600"
                          >
                    ...
                    >
                        ...
                        <button 
                            ...
                            className="w-full group relative overflow-hidden rounded-2xl bg-slate-900 dark:bg-white text-white dark:text-black font-display font-bold uppercase tracking-widest text-lg py-5 px-8 transition-all hover:bg-blue-600 dark:hover:bg-blue-600 hover:text-white dark:hover:text-white disabled:opacity-70 disabled:cursor-not-allowed hover:shadow-lg dark:hover:shadow-[0_0_30px_rgba(255,255,255,0.2)]"
                        >
