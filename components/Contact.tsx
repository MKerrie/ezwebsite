...
const StyledInput = ({ label, type = "text", placeholder, value, onChange, required = false }: any) => (
    <div className="flex flex-col gap-2 group w-full">
        <label className="text-xs font-bold uppercase tracking-widest text-slate-500 dark:text-gray-400 ml-1 group-focus-within:text-fuchsia-600 dark:group-focus-within:text-fuchsia-400 transition-colors">
        ...
        {type === 'textarea' ? (
            ...
            />
             ...
             <input
                ...
                onChange={onChange}
                placeholder={placeholder}
                className="w-full bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl px-5 py-4 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-fuchsia-500/20 focus:border-fuchsia-500 transition-all placeholder:text-slate-400 dark:placeholder:text-neutral-600 hover:border-slate-300 dark:hover:border-white/20 shadow-sm dark:shadow-none"
             />
        )}
    </div>
);
...
const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" ref={ref} className="py-24 bg-slate-50 dark:bg-black text-slate-900 dark:text-white relative overflow-hidden transition-colors duration-300 w-full">
      ...
      <div className="absolute top-1/2 right-0 w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-fuchsia-900/5 dark:bg-fuchsia-900/10 blur-[80px] md:blur-[150px] pointer-events-none rounded-full transform -translate-y-1/2 translate-x-1/2" />
                  ...
                  {formState === 'success' ? (
                    ...
                    >
                        ...
                        <button 
                            ...
                            className="w-full group relative overflow-hidden rounded-2xl bg-slate-900 dark:bg-white text-white dark:text-black font-display font-bold uppercase tracking-widest text-lg py-5 px-8 transition-all hover:bg-fuchsia-600 dark:hover:bg-fuchsia-600 hover:text-white dark:hover:text-white disabled:opacity-70 disabled:cursor-not-allowed hover:shadow-lg dark:hover:shadow-[0_0_30px_rgba(255,255,255,0.2)]"
                        >
