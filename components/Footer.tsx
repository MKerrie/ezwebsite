      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 md:mb-24 border-b border-slate-200 pb-16">
          ...
          <div className="mt-8 md:mt-0 w-full md:w-auto flex justify-center md:block">
             <a 
                ...
                className="group flex items-center justify-center w-32 h-32 md:w-48 md:h-48 rounded-full bg-slate-900 text-white font-bold text-lg md:text-xl uppercase tracking-widest hover:scale-110 hover:bg-violet-600 hover:text-white transition-all duration-300 shadow-xl"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 mb-24">
          ...
          <div className="col-span-1">
             ...
             <a href="tel:+31612345678" className="block font-display text-lg md:text-xl uppercase font-bold text-slate-400 hover:text-violet-500 transition-colors">+31 6 1234 5678</a>
