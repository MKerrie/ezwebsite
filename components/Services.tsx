    ...
    <section id="services" ref={ref} className="py-20 md:py-24 bg-slate-100 dark:bg-[#080808] text-slate-900 dark:text-white transition-colors duration-300">
      <div className="container mx-auto px-6">
        ...
        <div className="mb-20 md:mb-20">
          <span className="text-blue-600 font-bold tracking-[0.3em] uppercase text-xs mb-4 block">Onze Expertise</span>
          <h2 className="font-display font-bold text-5xl md:text-8xl uppercase leading-[0.85] tracking-tighter">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400">Fixen.</span>
          </h2>
        </div>
            ...
            >
              <div className="relative z-10 flex flex-col h-full justify-between">
                <div className="flex justify-between items-start mb-8">
                    <div className="w-16 h-16 rounded-[1.5rem] bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/10 flex items-center justify-center text-blue-600 shadow-sm group-hover:bg-blue-600 group-hover:text-white transition-all duration-300">
                         {/* Fix: Explicitly cast to React.ReactElement with className prop to resolve TS overload error */}
                ...
                <div>
                  <h3 className="font-display font-bold text-3xl uppercase mb-4 group-hover:text-blue-600 transition-colors">{service.title}</h3>
