      ...
      */}
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <motion.div 
          ...
          className="absolute top-[-10%] md:top-[-20%] left-1/2 -translate-x-1/2 w-[120vw] h-[120vw] md:w-[80vw] md:h-[80vw] bg-blue-600/15 dark:bg-indigo-600/20 blur-[80px] md:blur-[120px] rounded-full mix-blend-multiply dark:mix-blend-screen transition-transform duration-100 ease-out" 
        />
        ...
        <motion.div 
          ...
          className="absolute top-[20%] right-[-10%] w-[40vw] h-[40vw] bg-purple-500/20 dark:bg-violet-600/10 blur-[100px] rounded-full" 
        />
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 flex flex-col items-center">
        ...
        >
          ...
          <motion.div 
            ...
            className="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 rounded-full border border-blue-500/20 bg-blue-500/5 backdrop-blur-md mb-6 md:mb-8"
          >
          ...
          <div className="relative mb-6 md:mb-8 flex flex-col items-center w-full">
             ...
             <div className="text-[15vw] md:text-[9vw] font-display font-bold leading-[0.8] md:leading-[0.85] tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-indigo-500 to-purple-600 dark:from-blue-400 dark:via-indigo-400 dark:to-purple-400 uppercase pb-2 md:pb-4 overflow-hidden">
          ...
          >
            <a 
              ...
              className="w-full sm:w-auto px-8 py-3.5 md:py-4 bg-slate-900 dark:bg-white text-white dark:text-black rounded-full font-bold uppercase tracking-wider hover:scale-105 transition-transform shadow-lg shadow-blue-500/20 text-center text-sm md:text-base"
            >
              Bekijk Werk
            </a>
            <a 
          ...
          >
            ...
            <div className="relative bg-white/40 dark:bg-white/5 backdrop-blur-2xl border border-white/50 dark:border-white/10 rounded-t-2xl md:rounded-t-[3rem] p-3 md:p-6 shadow-2xl overflow-hidden group">
                ...
                <div className="relative aspect-[16/9] md:aspect-[21/9] rounded-lg md:rounded-[2rem] overflow-hidden bg-neutral-900">
                    ...
                    >
                        <div className="h-1.5 md:h-2 w-8 md:w-12 bg-blue-500 rounded-full mb-2 md:mb-3" />
            ...
            {/* Reflection / Shadow */}
            <div className="absolute -bottom-10 left-[5%] w-[90%] h-10 bg-blue-500/20 blur-[50px] rounded-[100%]" />
          </motion.div>
