      ...
      */}
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <motion.div 
          ...
          className="absolute top-[-10%] md:top-[-20%] left-1/2 -translate-x-1/2 w-[120vw] h-[120vw] md:w-[80vw] md:h-[80vw] bg-violet-600/15 dark:bg-indigo-600/20 blur-[80px] md:blur-[120px] rounded-full mix-blend-multiply dark:mix-blend-screen transition-transform duration-100 ease-out" 
        />
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 flex flex-col items-center">
        ...
        >
          ...
          >
            ...
            <span className="text-[10px] md:text-xs font-bold uppercase tracking-widest text-violet-600 dark:text-violet-400">
          ...
          <div className="relative mb-6 md:mb-8 flex flex-col items-center w-full">
             ...
             <div className="text-[15vw] md:text-[9vw] font-display font-bold leading-[0.8] md:leading-[0.85] tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-violet-600 via-indigo-500 to-purple-600 dark:from-violet-400 dark:via-indigo-400 dark:to-purple-400 uppercase pb-2 md:pb-4 overflow-hidden">
          ...
          >
            <a 
              ...
              className="w-full sm:w-auto px-8 py-3.5 md:py-4 bg-slate-900 dark:bg-white text-white dark:text-black rounded-full font-bold uppercase tracking-wider hover:scale-105 transition-transform shadow-lg shadow-violet-500/20 text-center text-sm md:text-base"
            >
              Bekijk Werk
            </a>
            <a 
